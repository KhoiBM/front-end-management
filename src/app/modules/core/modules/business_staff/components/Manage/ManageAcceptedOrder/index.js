...
import { SearchBar, ViewOrderInformation, ChangeStatusOrder } from 'src/app/modules/core/components';
import { useSearchHandle, useToggleViewInformation, useToggleFormAddEdit, useToggleChangeStatusForm, useToggleBox } from 'src/app/utils';
...
export const ManageAcceptedOrder = () => {
    ...
    return (
        <>
            {!openSendDemoProduct && !openViewInformation &&
                <Paper elevation={0} className={classes.mainContainer}>
                    <>
                        ...
                        <AcceptedOrderTable
                            ...
                            handleViewInformation={handleViewInformation} keywords={keywords} setSearchAction={setSearchAction} searchAction={searchAction} clickSearch={clickSearch} setClickSearch={setClickSearch} />
                    </>
                </Paper>
            }
