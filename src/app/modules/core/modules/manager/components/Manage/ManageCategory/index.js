...
export const ManageCategory = () => {
    ...
    return (
        <>
                ...
                <Paper elevation={2} className={classes.mainContainer}>
                    <>
                        <div className={classes.buttonAddWrapper}>
                            ...
                            <Button variant="outlined" color="primary" onClick={handleAdd} className={classes.buttonAdd}>Thêm thể loại</Button>
                        </div>
            ...
            {openEditForm && <EditCategoryForm recordForEdit={recordForEdit} handleCloseForm={handleCloseForm} />}
            {openAddForm && <AddCategoryForm handleCloseForm={handleCloseForm} />}
        </>
    )
}
