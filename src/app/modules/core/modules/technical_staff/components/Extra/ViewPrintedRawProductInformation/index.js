...
export const ViewPrintedRawProductInformation = (props) => {
                        ...
                        <Grid item xs={6} sm={6} md={6} className={classes.gridItem2}>
                            <Grid container>
                                <Grid item xs={12} sm={12} md={12} >
                                    ...
                                    <Box className={classes.categoryContainer}>
                                        <Typography variant={"subtitle1"} color={"textSecondary"}>Mã Code: {recordForViewInformation.printedProductCode}</Typography>
                                    </Box>
                                    <Box className={classes.titleContainer}>
                                        <Typography variant={"h3"}>{recordForViewInformation.printedProductName}</Typography>
                                    </Box>
                                ...
                                <Grid item xs={12} sm={12} md={12}>
                                    <Box className={classes.descriptionContainer}>
                                        <Typography variant={"h5"} color={"textSecondary"}>Mô tả:</Typography>
